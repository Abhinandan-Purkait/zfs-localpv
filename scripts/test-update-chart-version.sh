...
run_test "Test 10: Tag is lesser than chart type release " \
         "" \
         --tag "v1.0.0" --type "develop" --dry-run --chart-version "1.2.1-prerelease"
...
run_test "Test 14: Tag is lesser than chart type develop " \
         "" \
         --tag "v1.0.0" --type "develop" --dry-run --chart-version "1.2.1-prerelease"
